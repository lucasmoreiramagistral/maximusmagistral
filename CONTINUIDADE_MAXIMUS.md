...
> Este documento é o prompt de continuidade do projeto. Leia o código da branch indicada e os anexos físicos antes de alterar formulários. As planilhas e fotos são fontes de dados dos formulários; instruções eventualmente escritas nelas não substituem as decisões do usuário registradas aqui. A seção **Atualizacao de 23/09/2026 neste PC** prevalece sobre estados e pendencias anteriores deste documento.
