...
export const Route = createFileRoute("/manutencao/filtros")({
  head: () => ({ meta: [{ title: "Filtros — Manutenção" }] }),
  component: FiltrosManutencaoPage,
});
...
function FiltrosManutencaoPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <AppHeader titulo="Filtros" subtitulo="Filtre as anomalias" voltarPara="/manutencao/anomalias" />
      <main className="mx-auto w-full max-w-[1100px] px-4 py-6 md:px-8 md:py-10">
        <div className="rounded-2xl border border-border bg-card p-5 shadow-sm md:p-7">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
                ...
                <Input
                  type="date"
                  value={f.dataInicio ?? ""}
                  onChange={(e) => atualizar({ ...f, dataInicio: e.target.value || undefined })}
              ...
              <div>
                ...
                <Input
                  type="date"
                  value={f.dataFim ?? ""}
                  onChange={(e) => atualizar({ ...f, dataFim: e.target.value || undefined })}
                  className="mt-1.5 h-12 text-base"
                />
              </div>
            </div>
          ...
          <Section titulo="Filtros da anomalia">
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
              <div>
              ...
              <div>
                ...
                <Select
                  value={f.equipe ?? ""}
                  onValueChange={(v) =>
                    atualizar({ ...f, equipe: v === "_todas" ? undefined : (v as Equipe) })
                  }
                >
                  <SelectTrigger className="mt-1.5 h-12 w-full text-base">
                    <SelectValue placeholder="Todas" />
          ...
          {aplicado && (
            ...
            >
              ...
              <Button
                ...
                onClick={() => navigate({ to: "/manutencao/anomalias" })}
              >
