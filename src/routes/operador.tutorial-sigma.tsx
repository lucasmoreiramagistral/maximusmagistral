                  ...
                  {({ zoomIn, zoomOut, resetTransform }) => (
                    <>
                      ...
                      <button
                        ...
                        className="absolute left-4 top-4 z-[60] flex h-14 min-w-[180px] items-center justify-center gap-2 rounded-full bg-primary px-5 font-semibold text-primary-foreground shadow-xl transition-all hover:bg-primary/90 active:scale-[0.95]"
                      >
                      ...
                      <div className="pointer-events-none absolute bottom-4 left-4 z-[60] hidden max-w-xs rounded-lg bg-background/85 px-3 py-2 text-xs text-foreground shadow-lg backdrop-blur md:block">
